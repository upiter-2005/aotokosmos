	...
	<div class="wrap">
		...
		<form method="post" action="options.php">
			...
			<table class="form-table">
				 ...
				 */
				?>
				<tr valign="top"><th scope="row"><?php _e( 'Курс доллара к евро', 'sampletheme' ); ?></th>
					<td>
						<input id="sample_theme_options[dollar]" class="regular-text" type="text" name="sample_theme_options[dollar]" value="<?php esc_attr_e( $options['dollar'] ); ?>" />
					</td>
				</tr>
